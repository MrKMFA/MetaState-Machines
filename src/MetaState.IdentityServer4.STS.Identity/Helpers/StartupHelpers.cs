...
using MetaState.IdentityServer4.STS.Identity.Configuration.ApplicationParts;
using MetaState.IdentityServer4.STS.Identity.Configuration.Constants;
using MetaState.IdentityServer4.STS.Identity.Configuration.Interfaces;
using MetaState.IdentityServer4.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace MetaState.IdentityServer4.STS.Identity.Helpers
{
