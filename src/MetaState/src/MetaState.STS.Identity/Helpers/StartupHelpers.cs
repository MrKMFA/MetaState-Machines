...
using SendGrid;
using MetaState.Shared.Configuration.Email;
using MetaState.Shared.Email;
using MetaState.STS.Identity.Configuration;
using MetaState.STS.Identity.Configuration.ApplicationParts;
using MetaState.STS.Identity.Configuration.Constants;
using MetaState.STS.Identity.Configuration.Interfaces;
using MetaState.STS.Identity.Helpers.Localization;
using System.Linq;
using IdentityServer4;
using Microsoft.AspNetCore.Authentication.AzureAD.UI;
using Microsoft.AspNetCore.Authentication.OAuth;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using MetaState.Admin.EntityFramework.MySql.Extensions;
using MetaState.Admin.EntityFramework.PostgreSQL.Extensions;
using MetaState.Admin.EntityFramework.Shared.Configuration;
using MetaState.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using Microsoft.IdentityModel.Tokens;
using MetaState.Shared.Authentication;
using MetaState.Shared.Configuration.Identity;

namespace MetaState.STS.Identity.Helpers
{
